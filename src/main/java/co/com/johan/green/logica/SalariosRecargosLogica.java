...
public class SalariosRecargosLogica {
    ...
    public List<SalariosRecargosDTO> obtenerPorCargo(Long cargoId) {
        return convertirEntidad(persistencia.obtenerPorCargo(cargoId));
    }
    ...
    /**
     * Convierte una lista de SalariosRecargosDTO en una lista de
     * SalariosRecargos.
     *
    ...
    /**
     * Convierte una lista de SalariosRecargos en una lista de
     * SalariosRecargosDTO.
     *
