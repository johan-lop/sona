...
module.controller('NuevousuarioCtrl', ['$scope', '$filter', '$http', function ($scope, $filter, $http) {
        ...
        $http.get('./webresources/TipoDocumento/TodosEmpresa', {})
                .success(function (data, status, headers, config) {
                    $scope.tipoDocumentosEmpresa = data;
                }).error(function (data, status, headers, config) {
            alert("Error al consultar los tipos de documentos");
        });

        $scope.buscarEmpresas = function (valor) {
            $http.get('./webresources/Empresa/Nombre/' + valor, {})
                    .success(function (data, status, headers, config) {
                        return data;
                    }).error(function (data, status, headers, config) {
